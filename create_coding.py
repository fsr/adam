...
if __name__ == '__main__':
    ...
    parser.add_argument('inputfiles', nargs='+', type=argparse.FileType('r'), metavar="inputfile",
                        help="plain text data file(s)")
    parser.add_argument("-o", "--output", type=argparse.FileType('w'), nargs=1,
                        help="JSON file the output is to be stored in")
