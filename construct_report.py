    ...
    for definition in reportdef:
        ...
        if questiontype == "?":
            ...
            for answer in choices:
                singleresult = get_result.get_question(dbname, coursename, "{}_{}".format(questionname, i),
                                                       definition["filter"], 1)
            ...
            answersums = get_result.get_question(dbname, coursename, questionname, definition["filter"],
                                                 len(choices) + na_answer)[1:-1]

        # Build renderable from choices and answersums
        renderable = {"question": question["text"], "view": definition["view"], "comment": definition["comment"],
                      "answers": []}
...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--database", nargs=1, help="database containing table with the answers...",
                        required=True)
