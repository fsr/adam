...
if __name__ == '__main__':
    ...
    parser_plain.add_argument("-o", "--output", type=argparse.FileType('w'), nargs=1,
                              help="file the output is to be stored in")
    parser_html.add_argument("-o", "--output", type=argparse.FileType('w'), nargs=1,
                             help="file the output is to be stored in")
